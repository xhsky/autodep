...
pidfile "{located}/redis/redis.pid"
...
logfile "{located}/redis/logs/redis.log"
...
# Generated by CONFIG REWRITE
    ...
    """
    try:
        redis_conf_file=f"{located}/redis/conf/redis.conf"
...
logfile "{located}/redis/logs/sentinel.log"
